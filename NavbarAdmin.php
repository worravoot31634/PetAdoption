  ...
  <div id="menu" class="w3-top" style="display: block;">
    <div class="w3-white w3-card">
      ...
      <a href="adminHome.php" style="font-size: 20px;" class="w3-bar-item w3-button w3-white"><img width="110"
          src="./Images/logo.png"></a>
      <div style="margin-top: 10px;" class="w3-right w3-hide-medium w3-hide-small w3-animate-right">

        <a href="adminCheckSys.php" style="font-size: 20px;"
          class=" w3-bar-item w3-button w3-hide-medium w3-hide-small"><b>เช็คผู้ใช้ที่อยู่ในระบบ</b></a>
  ...
  <div id="searchMenu" class="w3-top" style="display: none;">
      <div class="w3-bar w3-white w3-card">
          ...
          <a href="adminHome.php" style="font-size: 20px;" class="w3-bar-item w3-button w3-white"><img width="100" src="./Images/logo.png"></a>
          <div style="margin-top: 10px;" class="w3-center w3-hide-small w3-animate-left">
              ...
              <a href="resultSearchAdmin.php" style="font-size:18px; " onclick="hideNav()"
