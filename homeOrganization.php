...
<body id="myPage">
  ...
  <div style="margin-top:35px;" class="w3-display-container w3-animate-opacity ">
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img style="width:100%;min-height:350px;max-height:600px; " class="d-block w-100" src="./Images/headerIndex.png" alt="First slide">
        </div>
        <div class="carousel-item">
          <img style="width:100%;min-height:350px;max-height:600px; " class="d-block w-100" src="./Images/headerIndex2.png" alt="Second slide">
        </div>
        <div class="carousel-item">
          <img style="width:100%;min-height:350px;max-height:600px; " class="d-block w-100" src="./Images/headerIndex3.png" alt="Third slide">
        </div>
      </div>
    ...
    <div class="w3-container w3-display-bottomleft w3-margin-bottom ">
      <a href="donateOrganization.php"><button class="w3-button w3-xlarge w3-theme w3-hover-teal ">บริจาคให้น้อน</button></a>
    </div>
  </div>
