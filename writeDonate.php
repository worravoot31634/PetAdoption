...
<body id="myPage">
    ...
    <div>
        ...
        <br><br>
        <center><b>
                <p style="font-size:35px;">ขอบริจาค</p>
            </b></center>
    </div>
                ...
                <div class="w3-half" style="background-color: #E2E0E0;">
                    ...
                    <center>
                        <div class="w3-row" style="width: 80%;">
                            <p><input type="text" style="width: 100%;border-radius: 5px;" class="w3-border" rows="15" name="topic"></textarea>
                            </p>
                        </div>
                    </center>
                    ...
                    <center>
                        <div class="w3-row" style="width: 80%;">
                            <p><textarea style="width: 100%;border-radius: 5px;" class="w3-border" rows="10" name="comment"></textarea>
                            </p>
                        </div>
                    </center>
                    ...
                    <center>
                        <div class="w3-row" style="width: 80%;">
                            <p><input type="text" style="width: 100%;border-radius: 5px;" class="w3-border" rows="15" name="totalprice"></textarea>
                            </p>
